...
public:
    udHttpRequest(const std::string &request);
    ~udHttpRequest();
...
udHttpRequest::udHttpRequest(const std::string &request)
{
    this->parse_http_request(request);
    this->handle_multipart_form_data();
}

udHttpRequest::~udHttpRequest()
{
}

void udHttpRequest::parse_http_request(const std::string &request)
{
...
void udHttpRequest::handle_multipart_form_data()
{
...
bool udHttpRequest::is_valid_json(const std::string &json_string) const
{
